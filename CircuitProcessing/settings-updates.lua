...
if mods['bobmodules'] then
  ...
  overwrite_setting('double-setting', 'bobmods-modules-start-bonus-pollution', 0.01)
  overwrite_setting('double-setting', 'bobmods-modules-start-bonus-consumption', 0.2)
  overwrite_setting('double-setting', 'bobmods-modules-start-bonus-productivity', 0.01)
  overwrite_setting('double-setting', 'bobmods-modules-start-bonus-pollutioncreate', 0.01)
