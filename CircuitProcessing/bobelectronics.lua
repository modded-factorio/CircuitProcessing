...
data:extend({
  {
    ...
    icon = "__CircuitProcessing__/graphics/icons/circuits/electronic-circuit-board.png",
    icon_size = 64,
    subgroup = "sb-circuit-board",
...
data:extend({
  {
    ...
    icon = "__CircuitProcessing__/graphics/icons/circuits/electronic-logic-board.png",
    icon_size = 64,
    subgroup = "sb-circuit-board",
...
data:extend({
  {
    ...
    icon = "__CircuitProcessing__/graphics/icons/circuits/electronic-processing-board.png",
    icon_size = 64,
    subgroup = "sb-circuit-board",
