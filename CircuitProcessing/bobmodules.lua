...
for _,v in pairs({'speed', 'effectivity', 'productivity'}) do
  ...
  data.raw.item[module].category = nil
  data.raw.item[module].tier = nil
  data.raw.item[module].effect = nil
  data.raw.item[module].art_style = nil
  data.raw.item[module].beacon_tint = nil
  data.raw.item[module].requires_beacon_alt_mode = nil
  data.raw.item[module].limitation = nil
  data.raw.item[module].limitation_message_key = nil
  ...
  data.raw.item[module3].category = nil
  data.raw.item[module3].tier = nil
  data.raw.item[module3].effect = nil
  data.raw.item[module3].art_style = nil
  data.raw.item[module3].beacon_tint = nil
  data.raw.item[module3].requires_beacon_alt_mode = nil
  data.raw.item[module3].limitation = nil
  data.raw.item[module3].limitation_message_key = nil
  ...
  data.raw.item[module5].category = nil
  data.raw.item[module5].tier = nil
  data.raw.item[module5].effect = nil
  data.raw.item[module5].art_style = nil
  data.raw.item[module5].beacon_tint = nil
  data.raw.item[module5].requires_beacon_alt_mode = nil
  data.raw.item[module5].limitation = nil
  data.raw.item[module5].limitation_message_key = nil
  ...
  data.raw.item[module7].category = nil
  data.raw.item[module7].tier = nil
  data.raw.item[module7].effect = nil
  data.raw.item[module7].art_style = nil
  data.raw.item[module7].beacon_tint = nil
  data.raw.item[module7].requires_beacon_alt_mode = nil
  data.raw.item[module7].limitation = nil
  data.raw.item[module7].limitation_message_key = nil
